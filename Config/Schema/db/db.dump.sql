...
insert  into `nastasia_course`(`course_id`,`course_name`,`created`,`modified`) values ('COMP23420','Software Engineering','0000-00-00 00:00:00','2014-02-21 20:00:56');
...
insert  into `nastasia_student_classes`(`class_id`,`course_id`,`room`,`start_date_time`,`end_time`,`repeat`,`group`,`created`,`modified`) values (23420,'COMP23420','1.3','2014-02-17 15:00:00','2014-02-17 17:00:00',7,'X','0000-00-00 00:00:00','0000-00-00 00:00:00');
insert  into `nastasia_student_classes`(`class_id`,`course_id`,`room`,`start_date_time`,`end_time`,`repeat`,`group`,`created`,`modified`) values (33512,'COMP33512 ','1.4','2014-02-19 10:00:00','2014-02-19 12:00:00',7,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00');
insert  into `nastasia_student_classes`(`class_id`,`course_id`,`room`,`start_date_time`,`end_time`,`repeat`,`group`,`created`,`modified`) values (33812,'COMP33812','1.1','2014-02-18 13:00:00','2014-02-18 14:00:00',7,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00');
insert  into `nastasia_student_classes`(`class_id`,`course_id`,`room`,`start_date_time`,`end_time`,`repeat`,`group`,`created`,`modified`) values (38120,'COMP38120','Collab','2014-02-21 13:00:00','2014-02-21 15:00:00',7,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00');
insert  into `nastasia_student_classes`(`class_id`,`course_id`,`room`,`start_date_time`,`end_time`,`repeat`,`group`,`created`,`modified`) values (38121,'COMP23420','Tootil 1','2014-07-21 20:53:00','2014-02-21 21:53:00',7,'','2014-02-21 21:53:59','2014-02-21 21:53:59');
...
insert  into `nastasia_user_courses`(`user_courses_id`,`user_id`,`course_id`,`group`,`created`,`modified`) values (1,8243654,'COMP22712','','0000-00-00 00:00:00','0000-00-00 00:00:00');
...
insert  into `nastasia_users`(`id`,`username`,`password`,`user_type`,`first_name`,`last_name`,`email`,`created`,`modified`) values (4,8943654,'dd00101a6962b75767b23429f64fa765','Teacher','Toby','Howard','tobyhoward@manchester.ac.uk','0000-00-00 00:00:00','2014-02-28 18:41:28');
