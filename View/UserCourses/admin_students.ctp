<div class="courses index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit'), array('controller' => 'users','action' => 'edit', $student['User']['id'])); ?>
			<?php echo $this->Form->postLink(__('Remove User from this Course'), array('action' => 'delete',$student['UserCourse']['user_courses_id']), null, __('Are you sure you want to delete # %s?', $student['UserCourse']['user_courses_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
        ...
        <li><?php echo $this->Html->link(sprintf(__('Add %s to this Course'), $user_type) , array('controller' => 'user_courses', 'action' => 'add_user', 'course_id' => $course_id, 'user_type' => $user_type)); ?> </li>
	</ul>
</div>
